...
import com.alteratom.dashboard.`object`.DialogBuilder.dialogSetup
...
class SliderTile : Tile() {
    ...
    override fun onReceive(
        ...
        (jsonResult["base"] ?: msg.toString()).toFloatOrNull()
    ...
    private fun control(e: MotionEvent, v: View?): Pair<Int, Boolean> {
        ...
        when (e.action) {
            ...
            ACTION_UP -> {
                ...
                send((mqtt.payloads["base"] ?: "@value").replace("@value", value.toString()))
